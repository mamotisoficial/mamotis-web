    ...
    <section style={{ padding:'11rem 2rem', textAlign:'center', position:'relative', overflow:'hidden' }}>
      ...
      <div style={{ position:'relative', zIndex:1 }}>
        <p style={{ fontFamily:"'Cormorant Garamond',serif", fontWeight:300, fontStyle:'italic',
          fontSize:'clamp(2rem,4.5vw,4rem)', lineHeight:1.3, maxWidth:'780px',
          margin:'0 auto 1.5rem', color:'var(--crema)' }}>
          "No estás comprando un bolso.<br />
          Estás{' '}<em style={{ color:'var(--oro)', fontStyle:'normal' }}>continuando</em>{' '}una historia."
        </p>
        <p style={{ fontFamily:"'DM Mono',monospace", fontSize:'.52rem',
          letterSpacing:'.4em', opacity:.22 }}>— MAMOTIS · Madrid</p>
      </div>
    </section>
  );
}
