...
export default function PreviewColeccion() {
  ...
  return (
    <section className="preview-section" style={{ padding: '6rem 5rem 9rem' }}>
      <div className="preview-header" style={{
        display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: '4rem',
      }}>
        <h2 style={{
      ...
      <div className="preview-grid" style={{
        ...
        {preview.map((p, i) => (
          <Link key={p.id} href={`/coleccion/${p.id}`}
            ...
            className={i === 0 ? 'preview-main' : 'preview-item'}
            style={{
